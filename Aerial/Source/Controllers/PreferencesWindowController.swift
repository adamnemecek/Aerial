...
NSOutlineViewDelegate, VideoDownloadDelegate {
    ...
    fileprivate func colorizeProjectPageLink() {
        ...
        coloredLink.addAttribute(kCTForegroundColorAttributeName as NSAttributedStringKey,
                                 value: color,
                                  range: fullRange)
    ...
    @IBAction func outlineViewSettingsClick(_ button: NSButton) {
        ...
        menu.insertItem(withTitle: "Uncheck All",
            action: #selector(outlineViewUncheckAll),
            keyEquivalent: "",
            at: 0)

        menu.insertItem(withTitle: "Check All",
            action: #selector(outlineViewCheckAll),
            keyEquivalent: "",
            at: 1)
